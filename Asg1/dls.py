...
class dls:
    ...
    def __init__(self, source, goal, file_name, depth_limit, dump_flag = False):
    ...
    def graphSearch(self):
        ...
        while not self.fringe.is_empty():
            ...
            ## Actions to perform if goal state is not found.
                ...
                if test_first_elem.depth < self.depth_limit:  ## Check for depth limit if it is reached do not perform search
