...
class greedy:
    ...
    def generate_successor(self,node,pos):
        successor = Tools().successor(node,pos,method="greedy") ## gives a function call to successor function in Tools class from tools module.
    ...
    def graphSearch(self):
        ...
        heuristic = Tools().heuristic(self.start_state,self.goal_state) ## calculates the heuristic cost needed for priority list.
